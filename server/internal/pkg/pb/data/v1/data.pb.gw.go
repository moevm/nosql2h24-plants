...
func request_DataAPI_ExportDBV1_0(ctx context.Context, marshaler runtime.Marshaler, client DataAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ExportDBV1Request
	var metadata runtime.ServerMetadata

	msg, err := client.ExportDBV1(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DataAPI_ExportDBV1_0(ctx context.Context, marshaler runtime.Marshaler, server DataAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ExportDBV1Request
	var metadata runtime.ServerMetadata

	msg, err := server.ExportDBV1(ctx, &protoReq)
	return msg, metadata, err
...
func request_DataAPI_ImportDBV1_0(ctx context.Context, marshaler runtime.Marshaler, client DataAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.ImportDBV1(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DataAPI_ImportDBV1_0(ctx context.Context, marshaler runtime.Marshaler, server DataAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ImportDBV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ImportDBV1(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDataAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DataAPIServer) error {
	...
	mux.Handle("GET", pattern_DataAPI_ExportDBV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_DataAPI_ExportDBV1_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_DataAPI_ExportDBV1_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_DataAPI_ImportDBV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_DataAPI_ImportDBV1_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
...
var (
	forward_DataAPI_ExportDBV1_0 = runtime.ForwardResponseMessage
